                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link href="/gallery" passHref>
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="group relative inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white transition-all duration-300 rounded-full bg-white/10 border border-white/20 hover:bg-white/20 hover:border-white/30 hover:shadow-[0_0_40px_rgba(139,92,246,0.4)] overflow-hidden w-full sm:w-auto"
                    >
                  ...
                  <Link href="/learn" passHref>
                    <motion.div
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="group relative inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white transition-all duration-300 rounded-full glass hover:bg-white/5 border-transparent hover:border-white/10 w-full sm:w-auto"
                    >
                      <span className="relative z-10 flex items-center gap-2">
